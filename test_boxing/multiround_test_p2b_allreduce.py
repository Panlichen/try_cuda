...
def _test_partial_sum_to_broadcast(test_case, src_device_type, dst_device_type):
    ...
    def build_p2b(input_blob, src_device_num, dst_device_num):
        ...
        print("src_device_type {}, src_device_num {}, dst_device_type {}, dst_device_num {} done".format(
            src_device_type, src_device_num, dst_device_type, dst_device_num
        ))
        return dst
